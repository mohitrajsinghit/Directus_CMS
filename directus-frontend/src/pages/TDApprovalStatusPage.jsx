...
// const dashboardId = "640a7116-c58c-4df5-8eef-a00d6ab0ba47";
...
export default function EmbedDashboard() {
  ...
  return (
    <div style={{ width: "100%", height: "100vh", padding: "1rem" }}>
      <h1 style={{ textAlign: "center", marginBottom: "10px" }}>TD Approval Dashboard</h1>
      {loading && <p style={{ textAlign: "center" }}>Waiting for Approval...</p>}
